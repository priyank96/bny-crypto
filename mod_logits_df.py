...
## normalizing data
if logits_df["price_contribution"].max() > 1:
    print("Scrtipt already ran! Skipping.")
else:
    print("Processing with_news_predictions_val_95_12h.csv...")
    ...
    logits_df.to_csv('with_news_predictions_val_95_12h.csv', index=False)